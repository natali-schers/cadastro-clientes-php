...
<body>
    <div class="container-fluid">
        ...
        <h2 class="text-center titulo">Lista de Clientes <i class="fa fa-users"></i></h2>
        ...
        <h5 class="text-left botao">
            <a href="views/page_register.php" class="btn btn-success btn-xs"><i class="fa fa-plus-square"></i> Novo Cadastro</a>
        </h5>
    </div>
</body>
</html>